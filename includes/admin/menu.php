...
function educare_menu() {
	...
	global $educare_main_menu, $view_results, $add_results, $import_results, $update_results, $settings, $about_educare;
...
function educare_enqueue_styles( $hook) {
    ...
    global $educare_main_menu, $view_results, $add_results, $import_results, $update_results, $settings, $about_educare;
    $allowed = array( $educare_main_menu, $view_results, $add_results, $import_results, $update_results, $settings, $about_educare );
