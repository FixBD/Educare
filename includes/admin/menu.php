...
/** =====================( Functions Details )======================
	...
	* Valited menu are:
		1		All Students 					(@since 1.2.4)
		2. 	Add Marks 						(@since 1.2.4)
		3. 	Add Results						(@since 1.0.0)
		4. 	View Results 					(@since 1.0.0)
		5. 	Import Results 				(@since 1.0.0)
		6. 	Update Results				(@since 1.0.0)
		7. 	Grading Systems 			(@since 1.2.0)
		8. 	Settings 							(@since 1.0.0)
		9. 	About Us							(@since 1.0.0)
...
// function educare_add_marks() {
// 	include (EDUCARE_ADMIN."menu/add-marks.php");
// }

// function educare_all_students() {
// 	include (EDUCARE_ADMIN."menu/all-students.php");
// }



// function educare_about_us() {
// 	include (EDUCARE_ADMIN."menu/about-us.php");
// }
